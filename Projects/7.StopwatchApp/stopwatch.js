...
$(function(){
    ...
    function addLap(){
        lapNumber++;
        var myLapDetails ='<div class="lap"><div class="laptimetitle">Lap'+lapNumber+'</div><div class="laptime"><span>'+format(lapMinutes)+'</span>:<span>'+format(lapSeconds)+'</span>:<span>'+format(lapCentiseconds)+'</spam></div></div>';
